export default async function handler(req, res) {
    ...
    const returnSimulation = (reason = "No API Key Detected") => {
        ...
        let responseText = `[SITREP: SIMULATED]\n[SIGNAL_STATUS: ${reason.toUpperCase()}]\n\n[EXECUTIVE_SUMMARY]\nRating: ${rand(6,9)}/10\nIntelligence sweep for ${location} complete. Strategic baseline indicators are stable. Monitoring global developments across 10 key sectors.\n\n[POLITICAL_STABILITY]\nRating: ${rand(5,9)}/10\nGovernment institutions in ${location} are maintaining operational continuity. Policy frameworks remain intact with standard activity.\n\n[TRADE_RELATIONS]\nRating: ${rand(5,8)}/10\nCross-border trade flows for ${location} are within monitored thresholds. Strategic corridors remain open.\n\n[TECHNOLOGY]\nRating: ${rand(6,9)}/10\nDigital infrastructure across ${location} is operating at peak capacity. Cybersecurity protocols are heightened in response to regional threat vectors.\n\n[ECONOMY]\nRating: ${rand(4,7)}/10\nEconomic indicators for ${location} show resilience. Employment data is stable with growth sectors mainted.\n\n[SOCIAL_TRENDS]\nRating: ${rand(6,9)}/10\nDemographic shifts and social engagement in ${location} remain positive. Digital connectivity continues to drive national social development.\n\n[ENERGY]\nRating: ${rand(5,8)}/10\nEnergy infrastructure in ${location} is operating at standard capacity. Strategic reserves are currently within national safety thresholds.\n\n[SUPPLY_CHAIN]\nRating: ${rand(6,8)}/10\nLogistics networks servicing ${location} are functioning with minor global disruptions. Primary mission resource delivery remains prioritized.\n\n[INFLATION]\nRating: ${rand(4,7)}/10\nInflationary pressures in ${location} are being managed through fiscal adjustments. Consumer price indices remain stable.\n\n[INFRASTRUCTURE]\nRating: ${rand(6,9)}/10\nCore infrastructure in ${location} is operational. Planned maintenance and upgrade programs are progressing according to schedule.`;
